  ...
  programs.firefox = {
    ...
    profiles.${username} = {
      ...
      settings = {
        ...
        "browser.newtabpage.activity-stream.spaces.activityOptOut" = true;
        "browser.newtabpage.activity-stream.spaces.storiesOptOut" = true;
        "browser.newtabpage.activity-stream.spaces.widgetsOptOut" = true;
